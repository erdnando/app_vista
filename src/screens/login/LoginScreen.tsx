         ...
         <ImageBackground style={styles.background} resizeMode='cover' source={require('../../assets/Background.png')}>
             <ScrollView>
                ...
                <View style={styles.formulario}>
                    ...
                    {/* ic_baseline-fingerprint */}
                    <InputPassword modo='normal' campo={usuario.password} width='78%' placeHolder='Senha' label='Senha' iconLeft='ic_outline-lock' iconRight='ic_round-close' iconSee='ic_outline-visibility' IconHide='ic_outline-visibility-off' ></InputPassword>
                ...
                <ButtonTextGoTo label='Forgot password' bottom={0} onPress={ async() =>  { 
